...
void load_fonts(void)
{
    ...
    if(fontPath != NULL) {
        const char* allChinese =
            ...
            "调节优部进利告给议态警止持"
            "一二三四五六七八九十百友父母兄弟姐妹丈夫妻子"
            "吃饭喝水睡觉走路说笑跑跳坐站躺春夏秋冬"
            "红黄蓝绿黑白灰紫橙天地水火花草鱼鸟鸡狗猪猫兔龙蛇牛羊虫"
            "东西南外中间旁边正反内外上下大小长短高矮宽窄"
            "厚薄深浅粗细早晚冷暖凉热干湿软硬酸甜苦辣咸香"
            ...
            "板并布操层称冲出初答达带第顶段乏方符辅赋隔功共滚哈函含环绘激集简角捷今局空况立连练两列满描默哦抛配匹强区染首术树述随条统希系线形渲循压样阴引右域载暂增栈针知值指致重追自踪";
